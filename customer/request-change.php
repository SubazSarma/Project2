        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Price Change</h1>

                            <!-- Circle Buttons -->
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Request Price Change</h6>
                                </div>
                                <div class="card-body">
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Request Price Change</h2>

             <form method="post" action="request-change.php?id='$id'">

                <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example1cg">Price</label>
                  <input type="text" id="form3Example1cg" required name="price" class="form-control form-control-lg" />
                </div>
                <div class="d-flex justify-content-center">
                  <div class="input-group">
                    <input type="submit" name="price_btn" value="Change">
                  </div>
                </div>
