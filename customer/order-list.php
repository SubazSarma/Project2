                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <?php
                                    include('config.php');
                                    $result = mysql_query("SELECT * FROM paidorders inner join books on paidorders.bookId = books.bookId where username='$user'")
                                    or die(mysql_error());
                                echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>";
                                    echo "<tr>
                                        ...
                                        echo'<td> <form class="updateform" action="editprice.php?p=updateprice&orderId='.$row['id'].'" method="POST">
                                        <input type="text" name="prc" value='.$row['changeprice'].' style="width:50px;"/>
