...
<?php
      ...
      echo '<div class="content">';
                            echo '<image src = "../bookstore/images/books/'.$row['image'].'" width="160" height="200">';
                            echo'<h3>'.$row['title'].'</font></h3>';
                            echo'<p>$ '.$row['price'].'</p></font>';
                            echo'<p> <font color="black" size="3px">Category: '.$row['name'].'</p></font>';
                            echo'<p><button class = "buy-1"><a href="add-to-cart.php?id='. $row['bookId'] . '"><font color="white" name="btn">Add to Cart</font></button></p>';
                            echo'</div>';
                            echo "</div";
